...
% Measure properties including Centroid, Orientation, and Area
stats = regionprops("table", labeledImage, 'Centroid', 'Orientation', 'Area');
    
% Initialize list to store centroids, orientations, and areas
objectsData1 = [];
...
for k = 1:numObjects
    ...
    objectsData1 = [objectsData1; centroid, orientation, area]; % Append data to the list
...
% Display the list of objects' data (centroids, orientations, and areas)
disp('Objects Data (Centroid, Orientation, Area):');
disp(objectsData1);
